...
<body>
    ...
    <form class="form-horizontal" id="admission" method="POST">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input id="Enter  Full Name" name="name" type="text" placeholder="Enter Full Name" class="form-control input-md" required=""size="30 30">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input id="Enter DOB" name="DOB" type="date" placeholder="Enter DOB" class="form-control input-md" >
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <select id="Blood Group" name="blood" class="form-control1">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <select id="Caste Category" name="caste" class="form-control2">
...
<div class="form-group">
    ...
    <div class="col-md-4">                     
      <textarea class="form-control" id="Address For Communication" name="addressfc" placeholder="Enter Address"></textarea>
    </div>
  </div><br>
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
      <input id="Conatact" name="contact"  placeholder="required" class="form-control input-md" required="">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input id="Contact Number" name="altcontact" placeholder="optional" class="form-control input-md" >
                    </div>
                  </div>
                </div><br>
...
<div class="content" id="education">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
              <input id="Pragramme Name" name="programme" type="text" placeholder="Pragramme Name" class="form-control input-md" required="">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
              <input id="Enrollment Number" name="enroll" type="text" placeholder="Enrollment Number" class="form-control input-md" required="">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <label class="checkbox-inline" for="checkboxes-0">
                  <input type="radio" name="year" id="checkboxes-0" value="First" checked>
                  First
                </label>
                <label class="checkbox-inline" for="checkboxes-1">
                  <input type="radio" name="year" id="checkboxes-1" value="Second">
                  Second
                </label>
                <label class="checkbox-inline" for="checkboxes-2">
                  <input type="radio" name="year" id="checkboxes-2" value="Third">
                  Third
                </label>
              </div>
            </div><br>
...
<div class="form-group">
    ...
    <div class="checkbox">
      <label for="Shift-0">
        <input type="radio" name="shift" id="Shift-0" value="I" checked>
        I
      </label>
      </div><br>
    <div class="checkbox">
      <label for="Shift-1">
        <input type="radio" name="shift" id="Shift-1" value="II">
        II
      </label>
      </div>
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
      <input id="No. of course registered" name="rcourse" type="number"  placeholder="No. of course registered" class="form-control input-md" required="">
    <!-- Text input-->
    <br>  <br>
<div class="form-group">
    <label class="col-md-4 control-label" for="Name of last examination appeared">Name of last examination appeared</label>  
    <div class="col-md-4">
    <input id="Name of last examination appeared" name="lexam" type="text" placeholder="last examination" class="form-control input-md" required="">
  ...
  <div class="form-group">
    ...
    <div class="col-md-4"> 
      <label class="radio-inline" for="Result of last examination appeared-0">
        <input type="radio" name="result" id="Result of last examination appeared-0" value="Pass" checked="checked">
        Pass
      </label> 
      <label class="radio-inline" for="Result of last examination appeared-1">
        <input type="radio" name="result" id="Result of last examination appeared-1" value="Fail">
        Fail
      </label>
    </div>
  </div><br>
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
      <div class="input-group">
        ...
        <input id="prependedtext" name="marks" class="form-control" placeholder="enter marks" type="text" required="">
      </div><br>
...
<div class="content">
            <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                  <input id="textinput" name="pname" type="text" placeholder="Father/Mother Name" class="form-control input-md">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                  <input id="textinput" name="occupation" type="text" placeholder="  Occupation/Designation" class="form-control input-md" required="">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input id="Contact Number" name="pcontact"  placeholder="Enter Contact Number" class="form-control input-md" required="">
                    <!-- Textarea -->
                    <br>  
    ...
    <div class="col-md-4">                     
      <textarea class="form-control" id="Address" name="paddress" placeholder="Enter Address"></textarea>
    </div>
  </div><br>
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
    <input id=" Guardian" name="gname" type="text" placeholder="Name of Local Guardian" class="form-control input-md" required="">
                     <!-- Textarea -->
                     <br>  <br>
<div class="form-group">
    <label class="col-md-4 control-label" for="Address" > </label>
    <div class="col-md-4">                     
      <textarea class="form-control" id="Address" name="gaddress" placeholder="Enter Address"></textarea>
    </div>
  </div><br>
    <!-- Password input-->
    <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="Contact Number" name="gcontact" placeholder="Required" class="form-control input-md" required="">
                  </div>
                </div><br>
                <div class="form-group">
                  <label class="col-md-4 control-label" for="Contact Number">Contact No. 2</label>
                  <div class="col-md-4">
                    <input id="Contact Number" name="galtcontact" placeholder="optional" class="form-control input-md" >
                            </div>
                          </div><br>
